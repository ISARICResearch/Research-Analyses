...
# Load the description and data files
...
# Update 'HOEVINTX2' based on conditions
...
# Load and process 'Internal_DS_2023-01-10.csv'
...
df3.to_excel(os.path.join(path, 'example_db_DSHO_means.xlsx'), index=False)
