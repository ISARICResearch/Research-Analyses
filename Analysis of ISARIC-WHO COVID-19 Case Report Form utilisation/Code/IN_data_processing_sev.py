# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 20:21:08 2023
...
data_dm_file = 'usub_db_sev.csv'
data_dm_ns_file = 'usub_db.csv'
...
data_DM_ns = pd.read_csv(os.path.join(path, data_dm_ns_file))
...
df2.to_excel(os.path.join(path, 'example_db_IN_sev.xlsx'), index=False)

# Read back the intermediate data
df2 = pd.read_excel(os.path.join(path, 'example_db_IN_sev.xlsx'))
...
df3.to_excel(os.path.join(path, 'example_db_IN_means_sev.xlsx'), index=False)
