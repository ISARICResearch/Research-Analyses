# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 10:24:34 2024
...
# Merge with data_DM and filter based on USUBJID
data_MB = pd.merge(data_MB, data_DM, on='USUBJID', how='left')
data_MB = data_MB.loc[data_MB['USUBJID'].isin(data_DM_sev['USUBJID'].unique())]
...
df3.to_excel(os.path.join(path, 'example_db_MB_means_sev.xlsx'), index=False)
